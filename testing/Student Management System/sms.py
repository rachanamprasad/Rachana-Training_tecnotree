...
sliderLabel=Label(root,font=('times new roman',28,'italic bold'),width=30,fg="darkblue")
...
logo_image=PhotoImage(file="C:\\Users\\Mahadra\\Downloads\\Student Management System-20230410T070747Z-001\\Student Management System\\student.png")
...
style.configure('Treeview', rowheight=40,font=('times new roman', 12, 'bold'), fieldbackground='white', background='black',)
style.configure('Treeview.Heading',font=('times new roman', 14, 'bold'),foreground='red')
